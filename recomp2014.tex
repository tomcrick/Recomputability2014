...
techniques to improve the efficiency of scientific exploration. In
...
linking together software, toolchains, systems and workflows,
providing an infrastructure for verification and validation of
scientific models and in particular, performance benchmarks.
\end{abstract}

% keywords
\begin{IEEEkeywords}
Reproducibility, Benchmarks, Models, Cloud Services, Computational Science, Open Science
\end{IEEEkeywords}
