...
% not just a question of releasing your code and making it citable
...
%Ben's example: get original model, do energy minimisation, do some other transform, do energy minimisation again. 
